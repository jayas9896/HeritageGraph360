...
/**
 * Configures security for insights service endpoints.
 * Importance: Enforces authentication for insight APIs.
 * Alternatives: Delegate enforcement to the gateway only.
 */
@Configuration
@EnableMethodSecurity
public class InsightsSecurityConfig {
    /**
     ...
     */
    @Bean
    public SecurityFilterChain insightsSecurityFilterChain(HttpSecurity http) throws Exception {
